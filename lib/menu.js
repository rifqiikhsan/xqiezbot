exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, instagram, whatsapp, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `👻*${BotName}*👻
...
• WHATSAPP : ${whatsapp}
• Youtube : Newbie tutorial
• Instagram : root_system404
• Pasang Iklan? Chat Whatsapp.

📺 *IKLAN* : *YOUTUBE NEWBIE TUTORIAL*
