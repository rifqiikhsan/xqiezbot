...
/////////////////
const BotName = 'RIFQI BOT'; 
const instagram = 'https://instagram.com/root_system404'; 
const whatsapp = 'https:wa.me/6289629814773'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCKayCg-VkqvYAkz_BrUNFPQ';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Rifqi ikhsan')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Rifqi ikhsan`)
})
